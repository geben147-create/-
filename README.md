...
| 길이 | 87.71초 | 112.86초 |
| LUFS-I | −9.76 | −14.00 |
| True Peak | **+0.85 dBTP** | **−1.00 dBTP** |
| Crest | 10.42 dB | 14.74 dB |
| LRA | 3.43 LU | 11.68 LU |
| 스테레오 상관 | 0.9169 | 0.9528 |
| DC 오프셋 | 0.0022 | 0.0000058 |
| 앞뒤 무음 | 0 / 1.16초 | 0 / 0초 |

이 표는 깨끗한 체크아웃에서 재현됩니다. 테스트 곡 생성이 실행마다 같은 바이트를 내는지
`test_test_track_generation_is_byte_stable` 로 고정해 두었습니다.
...
37개 단위 테스트가 통과합니다. 리미터 릴리스 수식이 기준 재귀식과 1e-9 dB 이내로 일치하는지,
